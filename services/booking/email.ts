      ...
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: white; padding: 24px; border: 1px solid #e5e7eb; border-top: none;">
          ...
          <p style="font-size: 14px; color: #4b5563; line-height: 1.6;">
            Your deposit has been received and your booking is confirmed. Here are your details:
          </p>
          ...
          <div style="background: #f9fafb; border-radius: 8px; padding: 16px; margin: 16px 0;">
            <table style="font-size: 14px; color: #4b5563; width: 100%;">
              ...
              <tr><td style="padding: 4px 0; font-weight: 600;">Total:</td><td>$${booking.subtotal.toFixed(2)}</td></tr>
              <tr><td style="padding: 4px 0; font-weight: 600; color: #16a34a;">Deposit Paid:</td><td style="color: #16a34a;">$${booking.deposit.toFixed(2)}</td></tr>
              <tr><td style="padding: 4px 0; font-weight: 600;">Balance Due at Pickup:</td><td>$${booking.balance.toFixed(2)}</td></tr>
            </table>
          </div>
          ...
          <ol style="font-size: 14px; color: #4b5563; line-height: 1.8; padding-left: 20px;">
            <li>Full payment is due at pickup</li>
            <li>Once paid, you'll receive the lock code to access the trailer</li>
